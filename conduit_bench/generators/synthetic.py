...
VOCABULARY = {
    ...
    "narrative_aspect": ["unreliable narration", "sensory details", "internal monologue", "environmental storytelling"],
    ...
    "org_problem": ["project management", "code quality", "team collaboration", "innovation", "decision making"],
    ...
    "tech_location": ["Silicon Valley", "MIT", "Stanford", "CERN", "Bell Labs"],
